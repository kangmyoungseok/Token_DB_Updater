...
sql2 = "select * from ai_feature join pair_info on pair_info.id = ai_feature.pair_id where is_scam=0 and pair_info.created_at_timestamp >= 1629978354 order by pair_info.created_at_timestamp desc"
cursor.execute(sql2)
